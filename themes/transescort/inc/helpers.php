...
/**
 * TE FILE: inc/helpers.php
 * Helpers: linked profile id, profile ownership checks.
 * Loaded via functions.php
 */


/**
 * Returns linked Profile ID for user (user_meta: _linked_profile_id).
 *
 * @function transescort_get_linked_profile_id
 */
...
/**
 * Returns owner user_id for a Profile (post_meta: _profile_user_id).
 *
 * @function transescort_get_profile_owner_user_id
 */
...
if (!function_exists('transescort_user_owns_profile')) {
    /**
 * Checks if user owns given Profile (by profile owner meta or linked_profile_id).
 *
 * @function transescort_user_owns_profile
 */
