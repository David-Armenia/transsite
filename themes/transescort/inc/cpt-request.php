...
/**
 * TE FILE: inc/cpt-request.php
 * CPT Request: statuses, admin columns, metaboxes, access restrictions.
...
/**
 * Returns allowed Request statuses map.
 *
...
/**
 * Gets Request status from post_meta (default: new).
 *
 * @function transescort_get_request_status
 */
...
/**
 * Sets Request status in post_meta (validates against allowed statuses).
 *
 * @function transescort_set_request_status
 */
...
/**
 * Admin metabox renderer for Request details and status selector.
 *
 * @function transescort_request_details_metabox
 */
...
/**
 * Fetches latest Requests for given Profile ID.
 *
 * @function transescort_get_profile_requests
 */
...
/**
 * Converts status code to human label.
 *
 * @function transescort_request_status_label
 */
