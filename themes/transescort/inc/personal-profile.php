...
/**
 * TE FILE: inc/personal-profile.php
 * Frontend Personal Profile handlers: upload/delete photos, save city, create profile.
...
if (!function_exists('transescort_get_profile_image_url')) {
  /**
 * Helper: returns best Profile image URL (featured -> gallery first -> fallback).
 *
 * @function transescort_get_profile_image_url
 */
